        ...
        >
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            <div className="flex items-start">
              <div className="p-3 bg-white dark:bg-gray-700 rounded-lg mr-4">
                <Mail className="h-6 w-6 text-cyan-600 dark:text-cyan-400" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-cyan-600 mb-1">Email</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            <div className="flex items-start">
              <div className="p-3 bg-white dark:bg-gray-700 rounded-lg mr-4">
                <Phone className="h-6 w-6 text-cyan-600 dark:text-blue-400" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-cyan-600 mb-1">Phone</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            <div className="flex items-start">
              <div className="p-3 bg-white dark:bg-gray-700 rounded-lg mr-4">
                <MapPin className="h-6 w-6 text-cyan-600 dark:text-blue-400" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-cyan-600 mb-1">Location</h3>
